...
Computer.prototype.translate = function(txt) {
	...
	xhr.onload = function(e) {
		var arr = eval(e.target.response); // JSON.parse flakes out on the
											// response.
...
Computer.prototype.speak = function(txt) {
	...
	// Remove when https://code.google.com/p/chromium/issues/detail?id=333515 is
	// fixed.
	var sanitized = txt; // latinize(txt);
